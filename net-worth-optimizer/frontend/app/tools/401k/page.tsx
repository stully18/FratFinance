    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-bold mb-6">Your 401(k) Details</h2>
          ...
          <div className="bg-gradient-to-r from-blue-900/30 to-indigo-900/30 border border-blue-700 rounded-lg p-6">
            <h3 className="text-xl font-bold mb-4">Annual Contribution Breakdown</h3>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div>
                <div className="text-gray-400 text-sm mb-1">Your Contribution</div>
              ...
              <div>
                <div className="text-gray-400 text-sm mb-1">Employer Match (Free Money!)</div>
              ...
              <div>
                <div className="text-gray-400 text-sm mb-1">Total Annual</div>
            ...
            <div className="border-t border-gray-700 pt-6">
              <h3 className="text-xl font-bold mb-4">After {yearsToRetirement} Years</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gray-800/50 rounded-lg p-4">
                  <div className="text-gray-400 text-sm mb-1">Employer Contributed</div>
                ...
                <div className="bg-gray-800/50 rounded-lg p-4">
                  <div className="text-gray-400 text-sm mb-1">Investment Gains</div>
                ...
                <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 border border-purple-500 rounded-lg p-4">
                  <div className="text-gray-300 text-sm mb-1">Total 401(k) Value</div>
        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-bold mb-1">Contribute at Least to the Match</h4>
                <p className="text-gray-400 text-sm">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-bold mb-1">Choose Your Investments</h4>
                <p className="text-gray-400 text-sm">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-bold mb-1">Increase Contributions Over Time</h4>
                <p className="text-gray-400 text-sm">
        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-bold mb-4">Traditional vs Roth 401(k)</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-900/20 to-blue-700/20 border border-blue-700 rounded-lg p-6">
              <h3 className="text-xl font-bold mb-3 text-blue-400">Traditional 401(k)</h3>
            ...
            <div className="bg-gradient-to-br from-purple-900/20 to-purple-700/20 border border-purple-700 rounded-lg p-6">
              <h3 className="text-xl font-bold mb-3 text-purple-400">Roth 401(k)</h3>
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-start gap-2">
                  <span className="text-green-400">+</span>
          ...
          <div className="mt-6 bg-yellow-900/20 border border-yellow-700 rounded-lg p-4">
            <p className="text-yellow-400 font-semibold mb-2">Pro Tip for New Grads</p>
            <p className="text-gray-300 text-sm">
              If you're just starting your career, you're probably in one of the lowest tax brackets you'll ever be in.
              <strong> Choose Roth 401(k) if available</strong> - pay the lower taxes now and enjoy tax-free growth forever.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-900/20 to-blue-900/20 border border-green-700 rounded-lg p-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <h3 className="text-xl font-bold mb-2">Already Maxing Your 401(k) Match?</h3>
            ...
            <Link
              href="/tools/roth-ira"
              className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-lg font-bold transition-all"
            >
